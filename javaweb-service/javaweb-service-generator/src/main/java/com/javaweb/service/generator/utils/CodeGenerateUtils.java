...
//    }
    ...
    public void generateFile(String tableName, String tableAnnotation) throws Exception {
        try {
            ...
            targetPath = projectPath + "/" + serviceName + "/" + moduleName + "/src/main/java/" + StringUtils.join(packageArr, "/");
    ...
    private void generateMapperFile() throws Exception {
        // 文件路径
        String path = projectPath + "/" + serviceName + "/" + moduleName + "/src/main/resources/mapper/";
        // 初始化文件路径
        initFileDir(path);
        // 文件后缀
